                        ...
                        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                            ...
                            <form method="POST" action="{{ route('clients.update', $client) }}">
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-text-input id="company_vat" class="block mt-1 w-full" type="number" name="company_vat" :value="old('company_vat', $client->company_vat)" required autocomplete="company_vat" />
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-text-input id="company_zip" class="block mt-1 w-full" type="number" name="company_zip" :value="old('company_zip', $client->company_zip)" required autocomplete="company_zip" />
