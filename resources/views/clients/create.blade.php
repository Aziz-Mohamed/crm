                            ...
                            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                                    ...
                                    <form method="POST" action="{{ route('clients.store') }}">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-text-input id="company_vat" class="block mt-1 w-full" type="number" name="company_vat" :value="old('company_vat')" required autofocus  />
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-text-input id="company_address" class="block mt-1 w-full" type="text" name="company_address" :value="old('company_address')" required autofocus  />
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-text-input id="company_city" class="block mt-1 w-full" type="text" name="company_city" :value="old('company_city')" required autofocus  />
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-text-input id="company_zip" class="block mt-1 w-full" type="number" name="company_zip" :value="old('company_zip')" required autofocus  />
